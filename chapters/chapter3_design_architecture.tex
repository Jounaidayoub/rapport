...
\begin{figure}[H]
    \centering
    \fbox{\parbox[c][5cm][c]{0.8\textwidth}{\centering Placeholder for PDF Report Screenshot}}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox[c][5cm][c]{0.8\textwidth}{\centering Placeholder for CSV Report Screenshot}}
